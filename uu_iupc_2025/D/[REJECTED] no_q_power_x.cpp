...
const int N = 1 << 21, mod = 998244353, P1 = 998244251, Q1 = 998244227, P2 = 998244209, Q2 = 998244103;
using ll = long long;
...
int get_hash1(int x) {
  return power(P1, x, mod);
}

int get_hash2(int x) {
  return power(P2, x, mod);
}
...
void solve() {
  ...
  for (int i = 0; i < n; i++) {
    hash_a = (hash_a + get_hash1(a[i])) % mod;
    hash_b = (hash_b + get_hash1(b[i])) % mod;
  }
  if (hash_a != hash_b) {
    cout << "0\n";
    return;
